...
Успешная отработка плейбука - создана папка для скачивания ПО, скачан файл для установки, выполнена установка 7zip (пример установки exe файла), скачан тестовый файл из репозитория (pdf):     
