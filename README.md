...
---
Реализовал развёртывание инфраструктуры в облаке для демонстрации, в связи с тем, что дома нет подходящего железа (ресурсы, лицензия , регистрация триал версиий продуктов и тд ) для полноценной реализации. Вначале опишу подход в целом, описание решений и инструментов, а ниже, после описания, то что сделано у меня в плане готовой реализации.
...
Подготовка образа с Windows для возможности импортировать его в yandex cloud и дальнейшего использования при создании VM.
Действия согласно официальной документации от Yandex:

Установить QEMU (был ранее установлен).
Установить Packer (был ранее был установлен).
1) Packer сборка образа
...
2) Выполнена сборка (команда "packer build ." )
...
3) Полученный образ загружен в ранее созданный Object Storage
"s3cmd --storage-class COLD put packer-w10gui s3://roomy-bucket-s3"

4) Импортирован образ в Compute Cloud для дальнейшего использования
