...
Sol установлен deb пакет на ubuntu машины:   
<p align="center"> <img src="./assets/sol.jpg"></p>
Успешная отработка плейбука, создана папка для скачивания ПО, выполнена установка, скачан тестовый файл из репозитория (pdf):     
