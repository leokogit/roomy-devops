...
Успешная отработка плейбука, создана папка для скачивания ПО, выполнена установка 7zip (пример установки exe файла), скачан тестовый файл из репозитория (pdf):     
